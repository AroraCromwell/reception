            ...
            return this._visitorStore.allPrintOut().then(function (res) {
                ...
                if (id == 1) {
                    ...
                    var options = {
                        ...
                        header: {
                            "height": "23mm",
                            "contents": '<div style="text-align: center;"><b>BRC Staff</b></div>' + '<div><b>Date :</b>' + result.rows.todayDate + '</div>' + '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 123px;float: left;">StaffId</div>' + '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 270px;float: left;">Name</div>' + '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 120px;float: left;">Signed In</div>' + '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 90px;float: left;">Status</div>' + '</div>'
                        },
                        footer: {
                            "height": "10mm",
