                        ...
                        var options = {
                            ...
                            header: {
                                ...
                                "contents": '<div style="text-align: center;"><b>BRC Site Visitors</b></div>' +
                                            ...
                                            '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 47px;float: left;">Id</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 141px;float: left;">Name</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 147px;float: left;">Company</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 85px;float: left;">Signed In</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 69px;float: left;">Status</div>'+
                                            '</div>'
                            },
                            footer: {
                                "height": "10mm",
