                ...
                if(id == 1) {
                    ...
                    var options = {
                        ...
                        header: {
                            ...
                            '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 170px;float: left;">StaffId</div>'+
                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 430px;float: left;">Name</div>'+
                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 190px;float: left;">Signed In</div>'+
