                ...
                return this._visitorStore.saveCustomer(data)
                    ...
                    .then(result => {
                        ...
                        pdf.create(html, options).toFile('./pdf/' + visitorId + '.pdf', function(err, pdfRes) {
                            ...
                            var cmd = '"C:\\Program Files (x86)\\Foxit Software\\Foxit Reader\\FoxitReader.exe" /t "C:\\reception-handler\\build\\pdf\\46.pdf" "BrotherHL-3150CDWseries" “IP_10.100.16.193"';
