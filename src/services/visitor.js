                        ...
                        var options = {
                            ...
                            header: {
                                ...
                                "contents": '<div style="text-align: center;"><b>BRC Site Visitors</b></div>' +
                                            ...
                                            '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 85px;float: left;">Id</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 260px;float: left;">Name</div>'+
