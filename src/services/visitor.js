                ...
                if(id == 1) {
                    ...
                    var options = {
                        ...
                        header: {
                            ...
                            '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 125px;float: left;">StaffId</div>'+
                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 325px;float: left;">Name</div>'+
                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 135px;float: left;">Signed In</div>'+
                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 120px;float: left;">Status</div>'+
                            '</div>'
                        },
                        footer: {
                            "height": "10mm",
                        ...
                        var options = {
                            ...
                            header: {
                                ...
                                "contents": '<div style="text-align: center;"><b>BRC Site Visitors</b></div>' +
                                            ...
                                            '<div style="float: left"><div style="border: 1px solid #dddddd;text-align: left;padding: 8px; width: 46px;float: left;">Id</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 150px;float: left;">Name</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 147px;float: left;">Company</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 83px;float: left;">Signed In</div>'+
                                            '<div style="border: 1px solid #dddddd;text-align: left;padding: 8px;width: 63px;float: left;">Status</div>'+
                                            '</div>'
                            },
                            footer: {
                                "height": "10mm",
